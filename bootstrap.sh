...
export SESSION_NAME=${SESSION_NAME:-zwift}

rm -rf ~/zerocloud
rm -rf /var/www/zwift-ui
...
apt-get install -y zerovm-zmq
cd ~
git clone https://github.com/zerovm/zerocloud.git
cd zerocloud
git checkout origin/havana
python setup.py install


# Swift Related Configurations
